  ...
  <div class="container">
    <div class="row" style="width: 150%">
        ...
        <ul class="social-links">
          ...
          <li><h6><a href="https://www.youtube.com/c/"><i class="fab fa-youtube"></i></a></h6></li>
        </ul> 
    </div>
  </div>
</div>
  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center">
      ...
      <a href="" class="logo d-flex align-items-center me-auto">
        ...
        <img src="{{asset('front/assets/img/logo-removebg-preview.png')}}" alt="">
        <h1 class="sitename">International Students</h1>
      </a>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#" class="active"><span>Profile</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
            <ul>
              ...
              <li><a href="{{url('visimisi')}}">vision and mission</a></li>
              <li><a href="{{url('structure')}}">structure</a></li>
              <li><a href="{{url('acreditation')}}">accreditation</a></li>
            </ul>
          </li>
